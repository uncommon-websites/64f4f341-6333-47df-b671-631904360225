...
<footer class="bg-brand-dark text-white pt-32 pb-12 overflow-hidden relative font-sans">
    <div class="max-w-7xl mx-auto px-4 relative z-10">
        <div class="text-center mb-24">
             <span class="text-[10px] font-bold uppercase tracking-widest border border-white/20 px-3 py-1.5 rounded-full mb-8 inline-block">Visibility Audits</span>
             <h2 class="text-5xl md:text-7xl font-serif-display mb-6">Ready to win in<br/> AI search?</h2>
             <p class="text-gray-400 mb-10 max-w-lg mx-auto text-sm">Get a free visibility audit and discover where your brand stands in ChatGPT, Perplexity, and Google AI Overviews.</p>
             
             <div class="flex flex-col sm:flex-row justify-center gap-2 max-w-md mx-auto">
                 <input type="email" placeholder="Enter your work email" class="bg-white/5 border border-white/10 rounded-lg px-4 py-3 w-full text-white placeholder-gray-500 focus:outline-none transition-colors" style="focus:border-color: oklch(0.769 0.188 70.08);" />
                 <button class="bg-white hover:bg-gray-100 text-gray-900 px-6 py-3 rounded-lg font-bold whitespace-nowrap transition-colors flex items-center justify-center">
                     Get Free Audit
        ...
        <div class="grid md:grid-cols-4 gap-12 border-t border-white/10 pt-16">
            <div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-8 mt-24 text-sm text-gray-400">
            <div>
