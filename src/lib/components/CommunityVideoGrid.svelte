<section class="py-24 bg-white border-t border-gray-200 font-sans">
    <div class="max-w-7xl mx-auto px-4 text-center mb-16">
        <span class="text-[10px] font-bold text-gray-500 uppercase tracking-widest border border-gray-200 px-3 py-1.5 rounded-full bg-gray-50">Answer Engine Optimization Academy</span>
        <h2 class="mt-8 text-5xl md:text-6xl font-serif-display text-gray-900">Master AI search <br/> optimization</h2>
        <p class="mt-6 text-gray-600 max-w-2xl mx-auto">Learn the strategies and tactics that leading consumer brands use to dominate visibility in ChatGPT, Perplexity, and Google AI Overviews.</p>
        <div class="mt-8">
    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="mt-12 flex flex-col md:flex-row items-center gap-8 max-w-5xl mx-auto">
            ...
            <div class="flex-1 text-center md:text-left">
                <blockquote class="text-2xl md:text-3xl font-serif-display leading-tight" style="color: oklch(0.666 0.179 58.318);">
                    "The Academy transformed how we think about AI search. Now we're proactive instead of reactive."
                </blockquote>
                <div class="mt-4 text-xs font-bold uppercase tracking-widest text-gray-400">
                    Marcus Rodriguez <br/>
                    <span class="text-gray-300">VP of Marketing, Brooklinen</span>
                </div>
            </div>
        </div>
    </div>
