<section class="py-24 bg-white font-sans">
    <div class="max-w-7xl mx-auto px-4 text-center mb-16">
         ...
         <h2 class="mt-8 text-5xl md:text-6xl font-serif-display text-gray-900">Everything you need to <br/> win in AI search</h2>
         <p class="mt-6 text-gray-600 max-w-2xl mx-auto">A complete platform for tracking, analyzing, and optimizing your brand's visibility across all major AI answer engines.</p>
    </div>
    ...
    <div class="max-w-6xl mx-auto px-4 border border-gray-200 bg-gray-50">
        ...
        <div class="grid md:grid-cols-2">
            <div class="p-12 border-b border-r border-gray-200 bg-[#FFF0F5]">
                <span class="text-[10px] font-bold uppercase tracking-widest border border-gray-200 bg-white px-2 py-1 rounded mb-6 inline-block">VISIBILITY TRACKING</span>
                <h3 class="text-3xl font-serif-display mb-4">Monitor your brand across all AI answer engines</h3>
                <p class="text-gray-600 mb-8 text-sm leading-relaxed">Track citations, rankings, and visibility metrics across ChatGPT, Perplexity, Google AI Overviews, and more from one unified dashboard.</p>
            ...
            <div class="p-12 border-b border-gray-200 bg-white flex items-center justify-center overflow-hidden">
                ...
                <div class="w-full h-full bg-white border border-gray-200 rounded-lg shadow-sm flex flex-col overflow-hidden text-[10px]">
                    <div class="bg-gray-50 border-b border-gray-100 px-4 py-2 flex items-center gap-2">
                        ...
                        <div class="flex items-center justify-between border-b border-gray-50 pb-2">
                         ...
                         <div class="flex items-center justify-between">
                            ...
                            <div class="flex -space-x-1">
                                ...
                                <div class="w-4 h-4 rounded-full bg-gray-400 border border-white"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Row 2 -->
        <div class="grid md:grid-cols-2">
            <div class="p-12 border-b border-r border-gray-200 bg-white flex items-center justify-center overflow-hidden">
            ...
            <div class="p-12 border-b border-gray-200 bg-[#FFF5EB]">
                <span class="text-[10px] font-bold uppercase tracking-widest border border-gray-200 bg-white px-2 py-1 rounded mb-6 inline-block">SEMANTIC ANALYSIS</span>
                <h3 class="text-3xl font-serif-display mb-4">Understand how AI engines interpret your content</h3>
                <p class="text-gray-600 mb-8 text-sm leading-relaxed">Get deep insights into semantic relationships, entity recognition, and topical authority that determine whether AI cites your brand.</p>
                <a href="#" class="text-xs font-bold flex items-center hover:underline">Learn More <svg class="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg></a>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-2">
            <div class="p-12 border-b border-r border-gray-200 bg-[#E6FFFA]">
                <span class="text-[10px] font-bold uppercase tracking-widest border border-gray-200 bg-white px-2 py-1 rounded mb-6 inline-block">COMPETITOR INTEL</span>
                <h3 class="text-3xl font-serif-display mb-4">See exactly what your competitors are doing</h3>
                <p class="text-gray-600 mb-8 text-sm leading-relaxed">Benchmark your visibility against competitors. Identify which brands are winning citations and reverse-engineer their optimization strategies.</p>
                <a href="#" class="text-xs font-bold flex items-center hover:underline">Learn More <svg class="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg></a>
            </div>
            <div class="p-12 border-b border-gray-200 bg-white flex items-center justify-center overflow-hidden">
        ...
        <div class="grid md:grid-cols-2">
            ...
            <div class="p-12 border-b border-gray-200 bg-[#FEFCBF]/30">
                <span class="text-[10px] font-bold uppercase tracking-widest border border-gray-200 bg-white px-2 py-1 rounded mb-6 inline-block">OPTIMIZATION PLAYBOOKS</span>
                <h3 class="text-3xl font-serif-display mb-4">Get actionable recommendations that work</h3>
                <p class="text-gray-600 mb-8 text-sm leading-relaxed">Receive specific, prioritized optimization strategies based on your visibility data. Know exactly what to change and why it matters.</p>
                <a href="#" class="text-xs font-bold flex items-center hover:underline">Learn More <svg class="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg></a>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-2">
            <div class="p-12 border-r border-gray-200 bg-[#E9D8FD]/30">
                <span class="text-[10px] font-bold uppercase tracking-widest border border-gray-200 bg-white px-2 py-1 rounded mb-6 inline-block">REPORTING & ALERTS</span>
                <h3 class="text-3xl font-serif-display mb-4">Stay informed with automated insights</h3>
                <p class="text-gray-600 mb-8 text-sm leading-relaxed">Get weekly visibility reports, instant alerts when competitors gain ground, and executive dashboards that show ROI at a glance.</p>
                <a href="#" class="text-xs font-bold flex items-center hover:underline">Learn More <svg class="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg></a>
            </div>
            <div class="p-12 bg-white flex items-center justify-center">
                 <!-- Integration Icons Grid Mockup -->
                 <div class="grid grid-cols-4 gap-4 w-full max-w-xs opacity-80">
                     {#each Array(12) as _, i}
                        <div class="aspect-square bg-gray-50 rounded border border-gray-100 flex items-center justify-center">
